...
1. **Jobs do Worker-Occurrence**: Os Jobs referenciados pelo `OutboxEventMapper` devem estar disponíveis no Worker-Occurrence. O Worker-Outbox apenas publica os jobs, não os processa.
